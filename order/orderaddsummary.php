...
sendGCM("New order Add: $Reserv_Title", "Order Descreption: $Reserv_Descriptions", "users", "", "");
...
VALUES ($lastID, '$Reserv_By_Employee_ID','$Reserv_By_Employee_Email', 'Add order Title: $Reserv_Title', 'Add order Descreption: $Reserv_Descriptions', current_timestamp())");
$stmt->execute();
